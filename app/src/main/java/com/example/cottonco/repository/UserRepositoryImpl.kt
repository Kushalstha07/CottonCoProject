...
class UserRepositoryImpl : UserRepository {
    // Firebase implementation for user authentication and data
    ...
    override fun register(
        ...
        auth.createUserWithEmailAndPassword(email,password)
            .addOnCompleteListener{
                if(it.isSuccessful){
                    callback(true,"Registered sucessfully","${auth.currentUser?.uid}")
    ...
    override fun updataProfile(
        ...
        ref.child(userId).updateChildren(data).addOnCompleteListener{
            if(it.isSuccessful){
                callback(true,"User profile updated successfully")
